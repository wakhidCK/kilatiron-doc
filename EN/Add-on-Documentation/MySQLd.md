...
## Features of the CloudKilat MySQLd Add-on
...
~~~
$ ironapp APP_NAME/DEP_NAME addon.add mysqld.OPTION
~~~
...
~~~
$ ironapp APP_NAME/DEP_NAME addon.upgrade mysqld.OPTION_OLD mysqld.OPTION_NEW
~~~
...
~~~
$ ironapp APP_NAME/DEP_NAME addon.downgrade mysqld.OPTION_OLD mysqld.OPTION_NEW
~~~
...
~~~
$ ironapp APP_NAME/DEP_NAME addon.remove mysqld.OPTION
~~~
...
~~~
$ ironapp APP_NAME/DEP_NAME addon mysqld.OPTION
Addon                    : mysqld.small
 Settings
