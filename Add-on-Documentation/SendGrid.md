...
~~~
$ ironapp APP_NAME/DEP_NAME addon.add sendgrid.OPTION
~~~
...
~~~
$ ironapp APP_NAME/DEP_NAME addon.upgrade sendgrid.OPTION_OLD sendgrid.OPTION_NEW 
~~~
...
~~~
$ ironapp APP_NAME/DEP_NAME addon.downgrade sendgrid.OPTION_OLD sendgrid.OPTION_NEW 
~~~

## Removing SendGrid

~~~
$ ironapp APP_NAME/DEP_NAME addon.remove sendgrid.OPTION
~~~
