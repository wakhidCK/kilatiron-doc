...
~~~
$ ironapp APP_NAME/DEP_NAME addon.add usersnap.OPTION
~~~
...
~~~
ironapp APPNAME/DEPLOYMENTNAME addon.creds
~~~
...
~~~
$ ironapp APP_NAME/DEP_NAME addon.upgrade usersnap.OPTION_OLD usersnap.OPTION_NEW
~~~
## Downgrade the Usersnap Add-on
Downgrading to another option can easily be done:
~~~
$ ironapp APP_NAME/DEP_NAME addon.downgrade usersnap.OPTION_OLD usersnap.OPTION_NEW
~~~
...
~~~
$ ironapp APP_NAME/DEP_NAME addon.remove usersnap.OPTION
~~~
## Add-on credentials
...
[CloudKilat Add-On-Credentials Doc](https://www.cloudcontrol.com/dev-center/guides/php/add-on-credentials-4).
...
[CloudKilat Add-On-Credentials Doc](https://www.cloudcontrol.com/dev-center/guides/python/add-on-credentials).
...
[CloudKilat Add-On-Credentials Doc](https://www.cloudcontrol.com/dev-center/guides/ruby/add-on-credentials-2).
...
option. [How to get add on credentials in CloudKilat](https://www.cloudcontrol.com/dev-center/platform-documentation#add-ons).
