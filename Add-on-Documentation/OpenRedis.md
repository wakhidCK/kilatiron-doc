...
OpenRedis provides hosted Redis services available to all CloudKilat apps.
...
~~~
$ ironapp APP_NAME/DEP_NAME addon.add openredis.OPTION
~~~
...
~~~
$ ironapp APP_NAME/DEP_NAME addon.upgrade openredis.OPTION_OLD openredis.OPTION_NEW
~~~
...
~~~
$ ironapp APP_NAME/DEP_NAME addon.downgrade openredis.OPTION_OLD openredis.OPTION_NEW
~~~
...
~~~
$ ironapp APP_NAME/DEP_NAME addon.remove openredis.OPTION
~~~
