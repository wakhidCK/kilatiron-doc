...
QuotaGuard Static is an Add-on that allows you to route outbound traffic through a static IP address on CloudKilat. You can provide this IP address to an API partner for IP based whitelisting and open your own firewall to access internal resources.
...
~~~
$ ironapp APP_NAME/DEP_NAME addon.add quotaguardstatic.OPTION
~~~
...
~~~
$ ironapp APP_NAME/DEP_NAME addon.upgrade quotaguardstatic.OPTION_OLD quotaguardstatic.OPTION_NEW
~~~
...
~~~
$ ironapp APP_NAME/DEP_NAME addon.downgrade quotaguardstatic.OPTION_OLD quotaguardstatic.OPTION_NEW
~~~
...
~~~
$ ironapp APP_NAME/DEP_NAME addon.remove quotaguardstatic.OPTION
~~~
...
~~~bash
$ ironapp app_name/dep_name config.add QUOTAGUARDSTATIC_MASK="100.30.68.0/24"
~~~
...
~~~bash
$ ironapp app_name/dep_name config.add QUOTAGUARDSTATIC_MASK="100.30.68.0/24,99.29.68.0/24"
~~~
...
Both IPs are shown on your QuotaGuard Static Dashboard which you can access by logging in to your CloudKilat console and clicking on the QuotaGuard Static Add-On from within one of your deployments.
...
We offer two products on CloudKilat, QuotaGuard and QuotaGuard Static.

QuotaGuard routes your traffic through a dynamic set of IP addresses that may change at any time and is intended for accessing APIs like Google Maps that restrict usage based on your IP address. It should be used if you want to access these APIs without your limit being shared with other CloudKilat apps.
