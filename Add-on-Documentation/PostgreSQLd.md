...
## Features of the CloudKilat PostgreSQLd Add-on
...
1. Easy, Managed Deployments
    ...
    configuration.
    - Automatic Software Patching - CloudKilat will make sure that the
...
~~~bash
$ ironapp APP_NAME/DEP_NAME addon.add postgresqld.OPTION
~~~
...
~~~bash
$ ironapp APP_NAME/DEP_NAME addon.upgrade postgresqld.OPTION_OLD postgresqld.OPTION_NEW
~~~
...
~~~bash
$ ironapp APP_NAME/DEP_NAME addon.downgrade postgresqld.OPTION_OLD postgresqld.OPTION_NEW
~~~
...
~~~bash
$ ironapp APP_NAME/DEP_NAME addon.remove postgresqld.OPTION
~~~
...
~~~bash
$ ironapp APP_NAME/DEP_NAME addon postgresqld.OPTION
