...
With CloudKilat, every deployment can feature a highly available hosted CouchDB provided by [Cloudant](https://cloudant.com/).
...
~~~
$ ironapp APP_NAME/DEP_NAME addon.add cloudant.OPTION
~~~
...
~~~
$ ironapp APP_NAME/DEP_NAME addon.upgrade cloudant.OPTION_OLD cloudant.OPTION_NEW
~~~
...
~~~
$ ironapp APP_NAME/DEP_NAME addon.downgrade cloudant.OPTION_OLD cloudant.OPTION_NEW
~~~
...
~~~
$ ironapp APP_NAME/DEP_NAME addon.remove cloudant.OPTION
~~~
