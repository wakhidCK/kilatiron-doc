...
~~~
$ ironapp APP_NAME/DEP_NAME addon.add indexdepot.OPTION
~~~
...
~~~
$ ironapp APP_NAME/DEP_NAME addon.upgrade indexdepot.OPTION_OLD indexdepot.OPTION_NEW 
~~~
...
~~~
$ ironapp APP_NAME/DEP_NAME addon.downgrade indexdepot.OPTION_OLD indexdepot.OPTION_NEW 
~~~

## Removing IndexDepot

~~~
$ ironapp APP_NAME/DEP_NAME addon.remove indexdepot.OPTION
~~~
...
Let's use the Zend Framework to index and search our first documents. This example assumes that you've downloaded and extracted it to the vendor folder inside the main directory of the CloudKilat tutorial app - so you should get similar output if you use *nix:

~~~
$ cd ~/ironcli_tutorial_app/ $ ~/ironcli_tutorial_app: ls vendor/Zend/ Acl Crypt Form Log.php Pdf Test
~~~
...
<field name="name">CloudKilat</field>
</doc>
<doc>
