...
~~~bash
$ git clone git@github.com:CloudKilat/nodejs-express-mongodb-example-app.git
...
[MongoLab] which can be found in CloudKilat's Add-on Marketplace under the
...
Finally, don’t forget to add the MongoLab Add-on for CloudKilat and deploy the
latest version of the app:

~~~bash
$ ironapp APP_NAME/default addon.add mongolab.free
