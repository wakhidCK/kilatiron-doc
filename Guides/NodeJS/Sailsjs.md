...
In Sails.js, client-backend communication is done using [websockets]. In order to use websockets, it is important to use `*.cloudcontrolapp.com` domain instead of `*.kilatiron.net`. For more details, take a look at the [CloudKilat websockets documentation].
...
[CloudKilat websockets documentation]: https://www.cloudcontrol.com/dev-center/platform-documentation#websockets
